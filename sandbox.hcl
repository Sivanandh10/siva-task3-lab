...
resource "vm" "workstation" {
  ...
  startup_script = <<-STARTEOF
    ...
    # nginx serves todoapp on port 80
...
NGINX
    ...
    # placeholder so Live App tab doesn't show 404
...
.box{text-align:center;color:#666;}.box h2{font-size:2rem;color:#333;margin-bottom:8px;}
</style></head>
<body><div class="box"><h2>📝 Todo App</h2><p>Start the lab to build your app!</p></div></body>
</html>
HTML
...
class Handler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        page = f"""<!DOCTYPE html>
<html><head><title>Git History</title>
...
pre{{background:#161b22;padding:20px;border-radius:8px;font-size:13px;line-height:1.8;border:1px solid #30363d;overflow-x:auto;min-height:100px}}
...
<body>
<h1>📦 Git History <span class="badge">Live</span></h1>
<pre>{html.escape(log)}</pre>
<p class="note">⟳ Auto-refreshes every 5 seconds — make commits and watch them appear!</p>
</body></html>"""
