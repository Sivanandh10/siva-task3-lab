...
# nginx config pointing to todoapp
...
.box{text-align:center;}.box h2{font-size:2rem;color:#333;margin-bottom:8px;}.box p{color:#888;}
</style></head>
<body><div class="box"><h2>📝 Todo App</h2><p>Follow the instructions to build your app!</p></div></body>
</html>
HTML
